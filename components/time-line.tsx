                    ...
                    {dataAboutPage.map((data) => (
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                <div className="text-xl font-bold text-gray-100 bg-gray-800 bg-opacity-60 p-2 rounded">{data.subtitle}</div>
                            </div>
                            <div className="text-gray-100 bg-gray-800 bg-opacity-60 p-2 rounded">{data.description}</div>
                        </div>
                    ))}
                </div>
            </div>
